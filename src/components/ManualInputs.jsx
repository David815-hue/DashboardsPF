...
const ManualInputs = ({ config, onConfigChange, dashboardType = 'venta-meta' }) => {
    ...
    return (
        <div className="manual-inputs">
            ...
            <div className="input-grid">
                {/* Meta - Only show for Venta Meta */}
                {dashboardType === 'venta-meta' && (
                    <>
                ...
                {/* WhatsApp - Only show for WhatsApp Marketing */}
